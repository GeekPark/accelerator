module.exports = function(grunt) {
        ...
        files: {
          '<%= paths.js %>app.min.js':
            [
              ...
              '<%= paths.srcjs %>jquery.fullpage.min.js',
              '<%= paths.srcjs %>geekpark.js',
              '<%= paths.srcjs %>app.js'
            ]
        }
      }
    ...
    slim: {
      dist: {
        ...
        files: {
          ...
          'pc_template.html': 'partials/pc_template.slim',
          'mobile_template.html': 'partials/mobile_template.slim'
        }
      }
    },
  ...
  grunt.registerTask('default', ['imagemin', 'uglify', 'concat', 'sass', 'autoprefixer', 'cssmin', 'connect', 'slim', 'watch']);
